...
const steps = [{
  ...
  icon: <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-medium-blue">
...
const HowItWorks = () => {
  ...
  return <section className="py-24 relative" id="how-it-works">
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <h2 className="text-3xl md:text-4xl font-bold mb-6">How Credivou Works</h2>
        ...
        visible: {
          ...
          {steps.map(step => <motion.div key={step.id} variants={{
          hidden: {
            opacity: 0,
            y: 20
          },
          visible: {
            ...
            transition: {
              ...
              {step.id < steps.length && <div className="hidden lg:block absolute top-1/2 -right-4 transform -translate-y-1/2 z-10">
